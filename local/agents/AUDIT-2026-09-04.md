...
>
> Scope note: the code audit ran against `/home/adamr/crude-sidecar/crude-engine/`
> (the real git/GitHub-tracked checkout), not this obsidian-vault copy — see
> `~/.claude/projects/-home-adamr/memory/crude-engine-repo-topology.md` for why
> there are two. None of the fixes below have been applied anywhere yet.
