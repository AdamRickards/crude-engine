...
Counts: floor_source gold **75** / 77; offline pass **51**; mops pass **75**; snmp pass **75**; ssh pass **34**.
...
**Rollup: proven `234` / possible `300` (78.0%).** Create→Execute→Resolve thickens this forever; lanes A′/B/C feed it.
