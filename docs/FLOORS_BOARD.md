...
Counts: floor_source gold **75** / 77; offline pass **51**; mops pass **75**; snmp pass **75**; ssh pass **31**.
...
**Rollup: proven `231` / possible `300` (77.0%).** Create→Execute→Resolve thickens this forever; lanes A′/B/C feed it.
