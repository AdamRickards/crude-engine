...
Counts: floor_source gold **75** / 77; offline pass **51**; mops pass **75**; snmp pass **75**; ssh pass **32**.
...
**Rollup: proven `232` / possible `300` (77.3%).** Create→Execute→Resolve thickens this forever; lanes A′/B/C feed it.
