...
The operating system for getting crude-engine from 2.9 to 2.10 and beyond.

| File | Role |
|------|------|
| [SEED.md](SEED.md) | Why, destination, bans, host = GitHub |
| [METHOD.md](METHOD.md) | Daily loop |
...
The bath-readable concept (HITL, packages, lab, vendors) lives outside this tree:

`~/Grok/project-analysis/CONCEPT.md`
