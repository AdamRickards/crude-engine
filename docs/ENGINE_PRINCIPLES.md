...
| New output shape | Canonical: engine formatters. Consumer: adapter. |
...
- Consumer output shaping (belongs in the adapter). Canonical shape lives in engine formatters.
- Credential handling
